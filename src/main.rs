...
fn main() {
    let mut possibly_corrupted_files = 0;
    ...
    println!("Possibly corupted files encountered during the decompression process: {}", possibly_corrupted_files);
}
